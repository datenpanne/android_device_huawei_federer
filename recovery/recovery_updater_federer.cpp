...
void Register_librecovery_updater_federer() {
    RegisterFunction("federer.verify_baseband", VerifyBasebandFn);
    RegisterFunction("federer.verify_trustzone", VerifyTrustZoneFn);
}
