...
FUSETOOL_IMAGES := \
    fusetool.b00 fusetool.b01 fusetool.b02 fusetool.b03 fusetool.mdt

FUSETOOL_SYMLINKS := $(addprefix $(TARGET_OUT_ETC)/firmware/,$(notdir $(FUSETOOL_IMAGES)))

$(FUSETOOL_SYMLINKS): $(LOCAL_INSTALLED_MODULE)
	@echo "Fingerprint firmware link: $@"
	@mkdir -p $(dir $@)
	@rm -rf $@
	$(hide) ln -sf /firmware/image/$(notdir $@) $@

ALL_DEFAULT_INSTALLED_MODULES += $(FUSETOOL_SYMLINKS)
